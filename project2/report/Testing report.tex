...
multiple rules\end{tabular}  \\
  ...
  \hline
  Purpose & \begin{tabular}[c]{@{}l@{}}The purpose of this test case is\\ to test the ability of the\\ program to reject a password\\ that fails multiple and is similar to\end{tabular}  \\
  \hline
  ...
  Current Password & 36!RacecaR* \\
  \hline
  Previous Password & vicLoaD1!9=ic \\
  \hline
  Expected Output & Rejected \\
  \hline
  Output & \\
  ...
  \hline
  Current Password & SHop5840!\@ \\
  \hline
  Previous Password & 110VAlid\@\#!2!24 \\
  \hline
  Expected Output & Rejected \\
  \hline
  Output & \\
  ...
  \hline
  Current Password & 11\_MultiPass; \\
  \hline
  Previous Password & 110VAlid\@\#!2!24 \\
  \hline
  Expected Output & Rejected \\
  ...
  \hline
  New Password & LidOffadaffodil4221 \\
  \hline
  Current Password & 234+.;SErifant \\
  \hline
  ...
  \hline
  Purpose & \begin{tabular}[c]{@{}l@{}}The purpose of this test case is\\ to test the ability of the\\ program to reject a password\\ that fails multiple rules and is\\ similar to, backwards\end{tabular}  \\
  \hline
  New Password & oc\#)0 =\textgreater \\
  \hline
  Current Password & COrrect440\@\# \\
  \hline
  Previous Password & ManySeats361=,\textgreater\$; \\
  \hline
  Expected Output & Rejected \\
  \hline
  Output & \\
  ...
  \hline
  Purpose & \begin{tabular}[c]{@{}l@{}}The purpose of this test case is\\ to test the ability of the\\ program to reject a password\\ that is too long, fails upper and numbers\\ and is similar to, backwards\end{tabular}  \\
  \hline
  New Password & lagnot,enonogongg\_et!\@upputeggnogonone-tongal \\
  \hline
  Current Password & 234\_)tongal, \\
  \hline
  Previous Password & 11\_MultiPass; \\
  \hline
  Expected Output & Rejected \\
  ...
  \hline
  Purpose & \begin{tabular}[c]{@{}l@{}}The purpose of this test case is\\ to test the ability of the\\ program to reject a password\\ that is similar to, both directions\end{tabular}  \\
  \hline
  New Password & FireS2!9)paSS12 \\
  \hline
  Current Password & 234+.;SErifant \\
  \hline
  Previous Password & SimPass12!! \\
  ...
  \hline
  Purpose & \begin{tabular}[c]{@{}l@{}}The purpose of this test case is\\ to test the ability of the\\ program to reject a password\\ that does not have enough numbers\end{tabular}  \\
  \hline
  New Password & NumberBoycott\_? \\
  \hline
  Current Password & SimPass12!! \\
  ...
  \hline
  Purpose & \begin{tabular}[c]{@{}l@{}}The purpose of this test case is\\ to test the ability of the\\ program to reject a password\\ that a space and invalid characters\end{tabular}  \\
  \hline
  New Password & \&\^{}!aa`CH9`1 chat \\
  \hline
  Current Password & ManySeats361=,\textgreater\$; \\
  \hline
  Previous Password & 234+.;SErifant \\
